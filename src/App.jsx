...
const App = () => {
  return (
    <div className="w-full h-[100vh] flex flex-col items-center justify-start overflow-hidden p-[10px] gap-[30px]">
      ...
      <button className="bg-gradient-to-r from-pink-500 to-cyan-500 hover:from-pink-400 hover:to-cyan-400 text-white font-semibold shadow-md shadow-cyan-500/40 transition rounded-full px-5 py-2 flex items-center gap-[20px]">
        click here{" "}
